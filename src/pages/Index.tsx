...
const CATALOG: {
  ...
  },
  {
    ...
    desc: "Мир вкусов, отражающий богатое кулинарное наследие Кореи. Заправки обладают неповторимым колоритом и глубиной вкуса. Ключевые ингредиенты корейских заправок — это соевый соус, кунжутное масло, чеснок, лук, имбирь и перец чили. Корейские заправки — это отличный способ добавить оригинальности и яркости в ваши блюда.",
  ...
  },
  {
    ...
    products: [
      { name: "Европейские", desc: "Соусы придают блюдам более сочную консистенцию и повышают их калорийность. Яркая окраска соусов выгодно оттеняет цвета основных продуктов блюда. Могут использоваться как для приготовления маринадов и заправок, так и для подачи к готовым блюдам, обогащая их вкус и делая их более аппетитными." },
      { name: "FoodService", desc: "Широкая гамма вкусовых ощущений — от нежных и сливочных до острых и пикантных, от традиционных до экзотических. Каждый соус разработан с учётом особенностей конкретного блюда, подчёркивая его вкус и аромат, делая его более насыщенным и интересным." },
      { name: "Азиатские", desc: "Соусы для производства азиатских блюд. Максимально упрощают технологический процесс приготовления блюд, при этом сохраняется их аутентичность и узнаваемость." },
    ],
  },
  {
    id: "grill",
  ...
  },
  {
    ...
    desc: "Водные конденсаты древесного дыма, освобождённые от балластных вредных веществ. Вырабатываемая с помощью жидкого дыма продукция по качеству аналогична продукции традиционного дымового копчения.",
  ...
  },
  {
    ...
    desc: "Тщательно разработанные композиции, предназначенные для создания аппетитной хрустящей корочки на различных продуктах: от мяса и птицы до рыбы и овощей. Сочетание ингредиентов обеспечивает превосходное сцепление с продуктом, равномерное обжаривание и насыщенный вкус.",
  ...
  },
  {
    ...
    products: [
      { name: "Концентраты для напитков", desc: "Специализированный продукт, разработанный для быстрого и лёгкого приготовления широкого ассортимента напитков — от освежающих лимонадов до насыщенных фруктовых коктейлей. Небольшое количество концентрата, разведённое водой, содовой или другими жидкостями, превращается в полноценный напиток. Универсальное решение для тех, кто ценит скорость, удобство и разнообразие вкусов." },
      { name: "Основа для пуншей", desc: "Концентрированные смеси, разработанные для создания широкого спектра алкогольных и безалкогольных пуншей с яркими и насыщенными вкусами. В состав входят фруктовые соки и пюре, экстракты, подсластители, специи и ароматизаторы. Представлены в широком ассортименте вкусов — от классических фруктовых до более экзотических и оригинальных сочетаний." },
    ],
  },
];
